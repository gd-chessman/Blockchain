      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div className="lg:col-span-3 order-1">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <ConnectedMembers connects={connects} memberBalances={memberBalances} checkedConnections={checkedConnections} handleCheckboxChange={handleCheckboxChange} setShowToast={setShowToast} />
          </div>
        </div>
      </div>
