                    ...
                    <table className="w-full">
                        <thead >
                            <tr className="text-sm text-muted-foreground border-b sticky top-0 bg-background">
                                <th className="text-left py-3 px-2">{t("trading.time")}</th>
                                <th className="text-left py-3 px-2 whitespace-nowrap">{t("trading.type")}</th>
                                <th className="text-left py-3 px-2">{t("trading.price")}</th>
                                <th className="text-left py-3 px-2">{t("trading.amount")}</th>
                                <th className="text-left py-3 px-2">{t("trading.total")}</th>
                                <th className="text-left py-3 px-2">{t("trading.status")}</th>
                                <th className="text-left py-3 px-2">{t("trading.address")}</th>
                            </tr>
                        </thead>
                        <tbody >
                            {orders.length === 0 ? (
